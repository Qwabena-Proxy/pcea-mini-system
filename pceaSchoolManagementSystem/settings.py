"""
Django settings for pceaSchoolManagementSystem project.
...
AUTH_USER_MODEL= 'core.StaffUserModel'

AUTHENTICATION_BACKENDS = [
    'django.contrib.auth.backends.ModelBackend',  # default backend
    'core.authBackend.StudentsModelBackend',  # custom backend
]
...
WSGI_APPLICATION = 'pceaSchoolManagementSystem.wsgi.application'
...
EMAIL_HOST_PASSWORD= 'tqfa otjb xozj opph'
EMAIL_USE_TLS= True
EMAIL_TIMEOUT = 60
EMAIL_USE_TLS = False
EMAIL_USE_SSL = True
