...
admin.site.register(ProgramsLevel)
...
admin.site.register(QualifiedStudents)
admin.site.register(GraduationRegistration)
admin.site.register(Graduants)
admin.site.register(GraduationList)